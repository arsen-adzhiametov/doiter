...
public final class GoalsListAdapter_
    extends GoalsListAdapter
{

    private Context context_;

    private GoalsListAdapter_(Context context) {
        context_ = context;
        init_();
    }
            ...
            if (view!= null) {
                view.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        listItemClicked(((Goal) parent.getAdapter().getItem(position)));
                    }
    ...
    public static GoalsListAdapter_ getInstance_(Context context) {
        return new GoalsListAdapter_(context);
    }
